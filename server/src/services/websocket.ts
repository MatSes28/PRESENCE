...
function handleDeviceMessage(ws: WebSocketClient, message: WSMessage, deviceId?: string | null) {
  switch (message.type) {
    case 'rfid_scan':
...
function handleWebMessage(ws: WebSocketClient, message: WSMessage, userId?: string | null) {
  switch (message.type) {
